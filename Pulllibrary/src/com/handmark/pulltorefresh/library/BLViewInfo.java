...
public class BLViewInfo {
	 ...
	 */
	public BLViewInfo(View view, int width, int height, int top, int bottom) {
		super();
		this.view = view;
		this.width = width;
		this.height = height;
	 ...
	 * @param height the height
	 */
	public BLViewInfo(View view, int width, int height) {
		super();
		this.view = view;
		this.width = width;
		this.height = height;
