...
public class BLMultiColumnListView extends ScrollView{
	...
	/**  Adapter. */
	private BLMultiColumnListAdapter mAdapter = null;
	
	/**  Adapter改变的监听器. */
	private AdapterDataSetObserver mDataSetObserver;
	
	/**  已加载的View. */
	private List<BLViewInfo> mItems = null;
	 ...
	 */
	public BLMultiColumnListView(Context context, AttributeSet attrs) {
	 ...
	 */
	public BLMultiColumnListView(Context context, AttributeSet attrs, int defStyle) {
		...
		mItems = new ArrayList<BLViewInfo>();
	}
	 ...
	 * @return the adapter
	 */
	public BLMultiColumnListAdapter getAdapter() {
		return mAdapter;
	}
	 ...
	 */
	public void setAdapter(BLMultiColumnListAdapter adapter) {
    ...
    protected void layoutChildren() {
    	...
    	if(mAdapter != null){
    		...
    		for (int i = 0; i < mItemCount; i++) {
    			BLViewInfo viewInfo = mAdapter.getView(i, null, null);
	 ...
	 */
	private void findColumnToAdd(BLViewInfo viewInfo) {
	...
	public boolean checkVisibility(int position) {
		BLViewInfo viewInfo = mItems.get(position);
