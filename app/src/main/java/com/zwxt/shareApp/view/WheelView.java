...
import com.zwxt.shareApp.CommonUnit;
import com.zwxt.shareApp.R;
import com.zwxt.shareApp.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    private void initData(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            TEXT_SIZE = CommonUnit.dip2px(context, TEXT_SIZE);
            VALUE_TEXT_SIZE = CommonUnit.dip2px(context, VALUE_TEXT_SIZE);
            array.recycle();
        }
