...
public class ShareApplication extends Application{
    ...
    public static int fid = Constants.convention;
    ...
    public void onCreate() {
        super.onCreate();
        token = Information.getStringConfig(getApplicationContext(), Information.SHARE_LOGIN, Information.ACCOUNT_TOKEN);
    ...
    AMapLocationListener locationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation location) {
            if (null != location) {
                ...
                getCityID(location.getCity());

                Intent intent = new Intent();
                intent.setAction(Constants.LOCATION_ACTION);
                intent.putExtra("city_name",location.getCity());
                getApplicationContext().sendBroadcast(intent);

//                locationClient.stopLocation();

//                System.out.println("定位成功:"+result);
            } else {
